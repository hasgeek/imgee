...
def upgrade():
    ...
    op.add_column('stored_file', sa.Column('width', sa.Integer(), server_default=sa.text('0')))
    op.add_column('stored_file', sa.Column('size', sa.BigInteger(), server_default=sa.text('0')))
    op.add_column('stored_file', sa.Column('height', sa.Integer(), server_default=sa.text('0')))
