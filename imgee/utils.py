...
ALLOWED_MIMETYPES = {
    ...
    'image/vnd.adobe.photoshop': {'allowed_extns':[u'.psd'], 'extn': u'.psd', 'thumb_extn': u'.jpeg'},
    ...
    'image/svg+xml': {'allowed_extns':[u'.svg'], 'extn': u'.svg', 'thumb_extn': u'.png'},
    'application/x-gzip': {'allowed_extns':[u'.svgz'], 'extn': u'.svgz', 'thumb_extn': u'.png'},
