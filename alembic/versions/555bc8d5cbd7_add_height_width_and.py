...
def upgrade():
    ...
    op.add_column('stored_file', sa.Column('width', sa.Integer(), default=0))
    op.add_column('stored_file', sa.Column('size', sa.BigInteger(), default=0))
    op.add_column('stored_file', sa.Column('height', sa.Integer(), default=0))
